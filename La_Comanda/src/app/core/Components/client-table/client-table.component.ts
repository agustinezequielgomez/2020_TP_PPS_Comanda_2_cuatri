...
import { Mesas, Mesa } from '../../Models/Classes/mesa';
...
export class ClientTableComponent implements OnInit {
  ...
  constructor(private camera: CameraService, public nav: NavController, private dataBase: DatabaseService) {}
